...
import org.backgram.ui.Cells.AboutLinkCell;
...
import org.backgram.ui.Cells.TextCell;
import org.backgram.ui.Cells.TextDetailCell;
import org.backgram.ui.Cells.TextInfoPrivacyCell;
...
import org.backgram.ui.Components.IdenticonDrawable;
    ...
    private boolean processOnClickOrPress(final int position) {
        if (position == usernameRow || position == channelNameRow) {
            ...
            if (userFull != null && userFull.phone_calls_available) {
                items.add(LocaleController.getString("CallViaBackgram", R.string.CallViaBackgram));
                actions.add(2);
            }
