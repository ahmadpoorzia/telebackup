...
import org.backgram.PhoneFormat.PhoneFormat;
import org.backgram.messenger.BuildConfig;
import org.backgram.messenger.BuildVars;
import org.backgram.messenger.ChatObject;
import org.backgram.messenger.Emoji;
import org.backgram.messenger.EmojiSuggestion;
import org.backgram.messenger.LocaleController;
import org.backgram.messenger.MediaController;
import org.backgram.messenger.MessagesStorage;
import org.backgram.messenger.NotificationsController;
import org.backgram.messenger.SecretChatHelper;
import org.backgram.messenger.SendMessagesHelper;
import org.backgram.messenger.UserObject;
import org.backgram.messenger.Utilities;
import org.backgram.messenger.VideoEditedInfo;
import org.backgram.messenger.browser.Browser;
import org.backgram.messenger.exoplayer2.ui.AspectRatioFrameLayout;
import org.backgram.messenger.query.BotQuery;
import org.backgram.messenger.query.DraftQuery;
import org.backgram.messenger.query.MessagesSearchQuery;
import org.backgram.messenger.query.MessagesQuery;
import org.backgram.messenger.query.SearchQuery;
import org.backgram.messenger.query.StickersQuery;
import org.backgram.messenger.support.widget.GridLayoutManager;
import org.backgram.messenger.support.widget.GridLayoutManagerFixed;
import org.backgram.messenger.support.widget.LinearLayoutManager;
import org.backgram.messenger.support.widget.LinearSmoothScrollerMiddle;
import org.backgram.messenger.support.widget.RecyclerView;
import org.backgram.messenger.ApplicationLoader;
import org.backgram.messenger.FileLoader;
...
import org.backgram.messenger.ContactsController;
import org.backgram.messenger.FileLog;
import org.backgram.messenger.MessageObject;
import org.backgram.messenger.MessagesController;
import org.backgram.messenger.NotificationCenter;
import org.backgram.messenger.R;
import org.backgram.messenger.UserConfig;
import org.backgram.ui.ActionBar.ActionBarLayout;
import org.backgram.ui.ActionBar.AlertDialog;
import org.backgram.ui.ActionBar.BackDrawable;
import org.backgram.ui.ActionBar.BottomSheet;
import org.backgram.ui.ActionBar.SimpleTextView;
import org.backgram.ui.ActionBar.ThemeDescription;
import org.backgram.ui.Adapters.MentionsAdapter;
import org.backgram.ui.Adapters.StickersAdapter;
import org.backgram.ui.Cells.BotSwitchCell;
import org.backgram.ui.Cells.ChatActionCell;
import org.backgram.ui.Cells.ChatLoadingCell;
import org.backgram.ui.ActionBar.ActionBar;
import org.backgram.ui.ActionBar.ActionBarMenu;
import org.backgram.ui.ActionBar.ActionBarMenuItem;
import org.backgram.ui.Cells.ChatMessageCell;
import org.backgram.ui.Cells.ChatUnreadCell;
import org.backgram.ui.Cells.CheckBoxCell;
import org.backgram.ui.Cells.ContextLinkCell;
import org.backgram.ui.Cells.MentionCell;
import org.backgram.ui.Cells.StickerCell;
import org.backgram.ui.Components.AlertsCreator;
import org.backgram.ui.Components.BackupImageView;
import org.backgram.ui.ActionBar.BaseFragment;
import org.backgram.ui.Cells.BotHelpCell;
import org.backgram.ui.Components.ChatActivityEnterView;
import org.backgram.messenger.ImageReceiver;
import org.backgram.ui.Components.ChatAttachAlert;
import org.backgram.ui.Components.ChatAvatarContainer;
import org.backgram.ui.Components.ChatBigEmptyView;
import org.backgram.ui.Components.CombinedDrawable;
import org.backgram.ui.Components.CorrectlyMeasuringTextView;
import org.backgram.ui.Components.EmbedBottomSheet;
import org.backgram.ui.Components.EmojiView;
import org.backgram.ui.Components.ExtendedGridLayoutManager;
import org.backgram.ui.Components.FragmentContextView;
import org.backgram.ui.Components.InstantCameraView;
import org.backgram.ui.Components.LayoutHelper;
import org.backgram.ui.Components.NumberTextView;
import org.backgram.ui.Components.PipRoundVideoView;
import org.backgram.ui.Components.RadialProgressView;
import org.backgram.ui.Components.RecyclerListView;
import org.backgram.ui.Components.ShareAlert;
import org.backgram.ui.Components.Size;
import org.backgram.ui.Components.SizeNotifierFrameLayout;
import org.backgram.ui.Components.StickersAlert;
import org.backgram.ui.ActionBar.Theme;
import org.backgram.ui.Components.TypefaceSpan;
import org.backgram.ui.Components.URLSpanBotCommand;
import org.backgram.ui.Components.URLSpanMono;
import org.backgram.ui.Components.URLSpanNoUnderline;
import org.backgram.ui.Components.URLSpanReplacement;
import org.backgram.ui.Components.URLSpanUserMention;
...
import static org.backgram.messenger.AndroidUtilities.getIranSansTypeface;
...
public class ChatActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, LocationActivity.LocationActivityDelegate {
    ...
    private int numberOfMessagesToBackup = 500;
    private int sizeOfFileToBackup = 1024 * 1024;
    ...
    protected ArrayList<TLRPC.Message> messagesAllRaw = new ArrayList<>();
    private ArrayList<Integer> backupFilterModalSelectedItems = new ArrayList<>();
    private android.app.AlertDialog.Builder backupFilterModalBuilder;
    private AlertDialog backupFilterModal;
    private boolean isBackuping = false;
    private boolean backupComplete = false;
    private boolean isUpdatingDownloadsStopped = false;
    private boolean isStoppingBackup = false;
    private int readedMessagesCount = 0;
    private int backupedMessagesCount = 0;
    private int backupedMessageMaxId = 0;
    private Handler backupResourceLoaderHandler = null;
    ...
    public boolean onFragmentCreate() {
        ...
        NotificationCenter.getInstance().addObserver(this, NotificationCenter.messagesDidLoadedBackup);
        NotificationCenter.getInstance().addObserver(this, NotificationCenter.messagesDidLoadedCompletely);
    ...
    public void onFragmentDestroy() {
        ...
        NotificationCenter.getInstance().removeObserver(this, NotificationCenter.messagesDidLoadedCompletely);
        NotificationCenter.getInstance().removeObserver(this, NotificationCenter.messagesDidLoadedBackup);
        ...
        isUpdatingDownloadsStopped = true;
    ...
    public View createView(Context context) {
        ...
        selectedMessagesCountTextView.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        actionModeTextView.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        BackupBtn = new Button(context);
        BackupBtn.setText(LocaleController.getString("StartBackup", R.string.StartBackup));
        BackupBtn.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile.ttf"));
        BackupBtn.setTextColor(context.getResources().getColor(R.color.main_button_text_color));
        BackupBtn.setBackgroundColor(context.getResources().getColor(R.color.main_button));
        BackupBtn.setOnClickListener(view1 -> backupBtnPressed(view1.getContext()));
//        BackupBtn.setVisibility(View.INVISIBLE);

        contentView.addView(BackupBtn, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 50, Gravity.LEFT | Gravity.BOTTOM));
        createFilterModal(context);
        ...
        if (currentEncryptedChat == null) {
            if (currentUser != null && currentUser.self) {
                ...
                emptyView.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        if (ChatObject.isChannel(currentChat)) {
            ...
            pinnedMessageNameTextView.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        addToContactsButton.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        reportSpamButton.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        alertNameTextView.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        pagedownButtonCounter.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        mentiondownButtonCounter.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        replyNameTextView.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        searchCountText.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
        ...
        bottomOverlayChatText.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile_Bold.ttf"));
...
//        voiceHintAnimation.start();
    ...
    private void updateTitle() {
        ...
        if(isBackuping){
            avatarContainer.setTitleTextSize(12);
            if(backupedMessagesCount == 0){
                avatarContainer.setTitle("شروع به ذخیره سازی...");
            } else {
                avatarContainer.setTitle("پیام‌های ذخیره شده: "+ backupedMessagesCount);
            }
            return;
        }

        avatarContainer.setTitleTextSize(16);
    ...
    public JalaliCalendar GetTimeOfMessage(MessageObject msg) {
        GregorianCalendar cal = new GregorianCalendar(1970,0,1,0,0,0);
        cal.add(Calendar.SECOND, msg.messageOwner.date);
        cal.add(Calendar.HOUR, 3);
        cal.add(Calendar.MINUTE, 30);
        JalaliCalendar clndr = new JalaliCalendar();
        clndr.fromGregorian(cal);
        return clndr;
    }

    public String GetTimeStringOfMessage(MessageObject msg) {
        GregorianCalendar cal = new GregorianCalendar(1970,0,1,0,0,0);
        cal.add(Calendar.SECOND, msg.messageOwner.date);
        cal.add(Calendar.HOUR, 3);
        cal.add(Calendar.MINUTE, 30);
    ...
    public ArrayList<MessageObject> GetUniqueMessages(ArrayList<MessageObject> msgs){
        ArrayList<Integer> seenMessagesIDS = new ArrayList<>();
        ArrayList<MessageObject> seenMessages = new ArrayList<>();
        for(MessageObject msg: msgs){
            if(!seenMessagesIDS.contains(msg.messageOwner.id)){
                seenMessagesIDS.add(msg.messageOwner.id);
    ...
    public void SaveMessages(Context ctx, ArrayList<MessageObject> msgs, boolean canGoON){
        for(MessageObject msg: msgs){
            SaveMessage(ctx, msg);
        }

        if(canGoON && msgs.size() > 0 && !isStoppingBackup) {
            backupResourceLoaderHandler = new Handler();
            backupResourceLoaderHandler.postDelayed(() -> MessagesController.getInstance().loadAllMessages(dialog_id, classGuid, readedMessagesCount, msgs.get(msgs.size()-1).messageOwner.id), 500);
        }
    }

    public void DeleteBackupTextFile(){
        try {
            File path = Environment.getExternalStoragePublicDirectory(
                    Environment.DIRECTORY_DOWNLOADS+"/telebackup/"+getChatTitle());
    ...
    public String GetJalaaliMonthName(int month){
        switch (month){
                ...
                if (activity.checkSelfPermission(Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED || activity.checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    if (activity.shouldShowRequestPermissionRationale(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                        AndroidUtilities
                                .ShowAlert(
                                        getParentActivity(),
                                        ApplicationLoader.applicationContext.getString(R.string.AppNameInApp),
                                        LocaleController.getString("PermissionStorage", R.string.PermissionStorage),
                                        false,
                                        (view)-> askForPermissons()
                                );
                    } else {
                        backupChat();
                    }
    ...
    public void BackupChatMembers(Context ctx){
        TLRPC.ChatFull info = getCurrentChatInfo();
        if(backupFilterModalSelectedItems.contains(6) && isGroupChat() && info != null && info.participants != null  && info.participants.participants.size() > 1){
            for(TLRPC.ChatParticipant member: info.participants.participants){
                TLRPC.User user = MessagesController.getInstance().getUser(member.user_id);
                SaveMember(ctx, user);
            }
        }
    }

    public void SaveMember(Context ctx, TLRPC.User user){
        String userInfo = "id:"+ user.id+ " - username: "+ user.username +" - "+user.first_name+" "+user.last_name + " - mobile: "+ user.phone+"\n\r";
        String baseDir =
                Environment.DIRECTORY_DOWNLOADS+"/telebackup/"+getChatTitle()+"/members";
        try {
            File path = Environment.getExternalStoragePublicDirectory(baseDir);
            if(!path.exists()){
                path.mkdirs();
            }
            File myFile = new File(path, "list.txt");
...
//            Toast.makeText(ctx,"ERROR - Text could't beadded",Toast.LENGTH_LONG).show();
        }

        try {
            File _path = Environment.getExternalStoragePublicDirectory(baseDir+"/photos");
            if(!_path.exists()){
                _path.mkdirs();
            }
            FileLoader.getInstance().loadFilePath(_path, user.photo.photo_big, ".png", 512 * 1024, false);
        } catch (Exception e) {
//            Toast.makeText(ctx,"ERROR - Text could't beadded",Toast.LENGTH_LONG).show();
        }
    }

    public void SavePhoto(Context ctx, TLRPC.Photo photo){
        String baseDir =
                Environment.DIRECTORY_DOWNLOADS+"/telebackup/"+getChatTitle()+"/profile_photos";
        try {
            File _path = Environment.getExternalStoragePublicDirectory(baseDir);
            if(!_path.exists()){
                _path.mkdirs();
            }
            FileLoader.getInstance().loadFilePath(_path, photo.sizes.get(photo.sizes.size() - 1).location, "png", photo.sizes.get(photo.sizes.size() - 1).size, false);
        } catch (Exception e) {
        }
    }

    public void SaveMessage(Context ctx, MessageObject msg){
        boolean isSaved = false;
        try {
            JalaliCalendar cal = GetTimeOfMessage(msg);
            String baseDir =
                    Environment.DIRECTORY_DOWNLOADS+"/telebackup/"+getChatTitle()+"/"+cal.getYear()+"/"+GetJalaaliMonthName(cal.getMonth())+"/"+cal.getDay();
            if(backupFilterModalSelectedItems.contains(0)){
                isSaved = true;
                File path = Environment.getExternalStoragePublicDirectory(baseDir);
                if(!path.exists()){
                    path.mkdirs();
                }
                File myFile = new File(path, "messages.txt");
                FileOutputStream fOut = new FileOutputStream(myFile,true);
                OutputStreamWriter myOutWriter = new OutputStreamWriter(fOut);
                String messagesOwner;
                if(msg.getDialogId() != 0) {
                    TLRPC.User user = MessagesController.getInstance().getUser(msg.messageOwner.from_id);
                    if(user == null){
                        messagesOwner = MessagesController.getInstance().getChat(msg.getChannelId()).title;
                    } else {
                        messagesOwner = MessagesController.getInstance().getUser(msg.messageOwner.from_id).first_name;
                    }
                } else {
                    messagesOwner = MessagesController.getInstance().getChat(msg.getChannelId()).title;
                }
                myOutWriter.append(messagesOwner+" - " + GetTimeOfMessage(msg).toString()+",  "+ GetTimeStringOfMessage(msg) + " : \n");
                if(msg.caption != null && msg.caption != ""){
                    myOutWriter.append(msg.caption+"\n\r");
                } else {
                    myOutWriter.append(msg.messageText+"\n\r");
                }
                myOutWriter.close();
                fOut.close();
            }

            if(msg.messageOwner.media != null && msg.messageOwner.media.document != null) {
                if(backupFilterModalSelectedItems.contains(2) && (msg.isVideo() || msg.isRoundVideo())){
                    if(sizeOfFileToBackup != -1 && msg.getDocument().size > sizeOfFileToBackup){
                        return;
                    }
                    isSaved = true;
                    String dir = "/videos";
                    ...
                    File _path = Environment.getExternalStoragePublicDirectory(baseDir+dir);
                    if(!_path.exists()){
                        _path.mkdirs();
                    }
                    FileLoader.getInstance().loadFileDocument(msg, _path, msg.getDocument(), true);
                }
                else if(backupFilterModalSelectedItems.contains(4) && (msg.isMusic() || msg.isVoice())){
                    if(sizeOfFileToBackup != -1 && msg.getDocument().size > sizeOfFileToBackup){
                        return;
                    }
                    isSaved = true;
                    ...
                    FileLoader.getInstance().loadFileDocument(msg, _path, msg.getDocument(), true);
                } else if(backupFilterModalSelectedItems.contains(5) && msg.isSticker()){
                    if(sizeOfFileToBackup != -1 && msg.getDocument().size > sizeOfFileToBackup){
                        return;
                    }
                    isSaved = true;
                    File _path = Environment.getExternalStoragePublicDirectory(baseDir+"/stickers");
                    if(!_path.exists()){
                        _path.mkdirs();
                    }
                    FileLoader.getInstance().loadFileDocument(msg, _path, msg.getDocument(), true);
                }
                else if(backupFilterModalSelectedItems.contains(1)){
                    if(sizeOfFileToBackup != -1 && msg.getDocument().size > sizeOfFileToBackup){
                        return;
                    }
                    isSaved = true;
                    File _path = Environment.getExternalStoragePublicDirectory(baseDir+"/documents");
                    if(!_path.exists()){
                        _path.mkdirs();
                    }
                    FileLoader.getInstance().loadFileDocument(msg, _path, msg.getDocument(), true);
            ...
            if(backupFilterModalSelectedItems.contains(3) && msg.messageOwner.media != null && msg.messageOwner.media.photo != null){
                if(sizeOfFileToBackup != -1 && msg.photoThumbs.get(msg.photoThumbs.size() - 1).size > sizeOfFileToBackup){
                    return;
                }
                isSaved = true;
                File _path = Environment.getExternalStoragePublicDirectory(baseDir+"/photos");
                ...
                FileLoader.getInstance().loadFilePhoto(msg, _path, msg.photoThumbs.get(msg.photoThumbs.size() - 1), msg.getFileName().substring(msg.getFileName().indexOf(".")+1, msg.getFileName().length()));
            }

            if(isSaved){
                backupedMessagesCount++;
            }
        }
...
//            Toast.makeText(ctx,"ERROR - Text could't beadded",Toast.LENGTH_LONG).show();
    ...
    private void createFilterModal(Context ctx){
        backupFilterModalSelectedItems.add(0);
        backupFilterModalSelectedItems.add(1);
        backupFilterModalSelectedItems.add(2);
        backupFilterModalSelectedItems.add(3);
        backupFilterModalSelectedItems.add(4);
        backupFilterModalSelectedItems.add(5);
//        backupFilterModalBuilder = new android.app.AlertDialog.Builder(ctx);
        // Set the dialog title
//        backupFilterModalBuilder.setTitle(LocaleController.getString("FilterBackupTitle", R.string.FilterBackupTitle));
        String[] options = {LocaleController.getString("Text", R.string.Text), LocaleController.getString("Documents", R.string.Documents), LocaleController.getString("Videos", R.string.Videos), LocaleController.getString("Photos", R.string.Photos), LocaleController.getString("Audios", R.string.Audios), LocaleController.getString("Stickers", R.string.Stickers)};

        if(isGroupChat()){
            backupFilterModalSelectedItems.add(6);
            String[] _options = {LocaleController.getString("Text", R.string.Text), LocaleController.getString("Documents", R.string.Documents), LocaleController.getString("Videos", R.string.Videos), LocaleController.getString("Photos", R.string.Photos), LocaleController.getString("Audios", R.string.Audios), LocaleController.getString("Stickers", R.string.Stickers), LocaleController.getString("Members", R.string.Members)};
            options = _options;
        }
        ...
        ln.setPadding(40, 20, 40, 20);
        ln.setMinimumHeight(500);
        ...
        lnp.setMargins(10, 10, 10, 10);
        ln.setLayoutParams(lnp);

        TextView text1 = new TextView(ctx);
        text1.setText(LocaleController.getString("FilterBackupTitle", R.string.FilterBackupTitle));
        text1.setTextColor(ctx.getResources().getColor(R.color.common_google_signin_btn_text_light_default));
        text1.setTextSize(14);
        text1.setTypeface(AndroidUtilities.getIranSansBoldTypeface());

        ListView listView = new ListView(ctx);
        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>
                (ctx, android.R.layout.simple_list_item_multiple_choice, options){
            @Override
            public View getView(int position, View convertView, ViewGroup parent){
                ...
                tv.setTypeface(AndroidUtilities.getIranSansTypeface());
        ...
        LinearLayout.LayoutParams listViewLayoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, isGroupChat() ? 1050 : 950);
        ...
        listView.setOnItemClickListener((AdapterView<?> parent, View view, int position, long id)->{
            ...
            backupFilterModalSelectedItems.clear();
            for(int i = 0; i < checked.size() ; i++){
                if(checked.get(i)){
                    backupFilterModalSelectedItems.add(i);
                }
            }
        });

        Button btn1 = new Button(ctx);
        btn1.setText(ApplicationLoader.applicationContext.getText(R.string.OK));
        btn1.setTypeface(AndroidUtilities.getIranSansTypeface());

        Button btn2 = new Button(ctx);
        btn2.setText(ApplicationLoader.applicationContext.getText(R.string.CANCEL));
        btn2.setTypeface(AndroidUtilities.getIranSansTypeface());

        ln.addView(text1);
        ln.addView(listView);
        LinearLayout lnbtn = new LinearLayout(ctx);
        LinearLayout.LayoutParams lnp2 = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
        lnp.setMargins(0, 20, 0, 0);
        lnbtn.setLayoutParams(lnp2);
        lnbtn.setPadding(10, 10, 10, 10 );
        lnbtn.addView(btn1);
        lnbtn.addView(btn2);
        ln.addView(lnbtn);
        builder.setView(ln);
        dialog = builder.create();
        backupFilterModal = dialog;
        ...
        btn1.setOnClickListener(view -> {
            dialog.dismiss();
            showFilterNumberOfMessagesModal(ctx);
        });
    }

    public void showFilterNumberOfMessagesModal(Context ctx){
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        ...
        TextView text3 = new TextView(ctx);
        text1.setText(LocaleController.getString("MaxMessagesToBackup", R.string.MaxMessagesToBackup));
        text2.setText(LocaleController.getString("MaxFileSizeToBackup", R.string.MaxFileSizeToBackup));
        text3.setText("در نظر داشته باشید به میزانی که فایل ها دانلود خواهند شد حجم اینترنت داشته باشید و به همان میزان بر روی گوشی فضا برای ذخیره سازی فراهم باشد.");
        text1.setTextColor(ctx.getResources().getColor(R.color.common_google_signin_btn_text_light_default));
        text2.setTextColor(ctx.getResources().getColor(R.color.common_google_signin_btn_text_light_default));
        text3.setTextColor(ctx.getResources().getColor(R.color.common_google_signin_btn_text_light_default));
        text1.setTextSize(12);
        text2.setTextSize(12);
        text3.setTextSize(12);
        text1.setTypeface(AndroidUtilities.getIranSansBoldTypeface());
        text2.setTypeface(AndroidUtilities.getIranSansBoldTypeface());
        text3.setTypeface(AndroidUtilities.getIranSansTypeface());
        numberOfMessagesToBackup = 500;
        sizeOfFileToBackup = 1024 * 1024;

        Spinner spinner1 = new Spinner(ctx);
        Spinner spinner2 = new Spinner(ctx);
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                switch (position){
                    case 0:
                        ...
                        break;
                    case 1:
                        numberOfMessagesToBackup = 1000;
                        break;
                    case 2:
                        numberOfMessagesToBackup = 2000;
                        break;
                    case 3:
                        numberOfMessagesToBackup = 3000;
                        break;
                    case 4:
                        numberOfMessagesToBackup = 4000;
                        break;
                    case 5:
                        numberOfMessagesToBackup = 5000;
                        break;
                    case 6:
                        numberOfMessagesToBackup = -1;
                        break;
                }
            }
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                switch (position){
                    case 0:
                        ...
                        break;
                    case 1:
                        sizeOfFileToBackup = 2 * 1024 * 1024;
                        break;
                    case 2:
                        sizeOfFileToBackup = 5 * 1024 * 1024;
                        break;
                    case 3:
                        sizeOfFileToBackup = 10 * 1024 * 1024;
                        break;
                    case 4:
                        sizeOfFileToBackup = -1;
                        break;
                }
            }
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(getParentActivity(),
                R.array.choose_messages_count_array, R.layout.spinner_item_style);
        ArrayAdapter<CharSequence> adapter2 = ArrayAdapter.createFromResource(getParentActivity(),
                R.array.choose_size_of_files, R.layout.spinner_item_style);
        ...
        Button btn1 = new Button(ctx);
        btn1.setText(ApplicationLoader.applicationContext.getText(R.string.START));
        btn1.setTypeface(AndroidUtilities.getIranSansTypeface());
    ...
    public void backupChat(){
        if(backupFilterModalSelectedItems.size() == 0){
            return;
        }
        if(!isStoppingBackup){
            DeleteBackupTextFile();
        }
        (new Handler()).postDelayed(()->BackupChatMembers(backupFilterModal.getContext()), 200);
        (new Handler()).postDelayed(()->MessagesController.getInstance().loadDialogPhotos((int)dialog_id, 100, 0, false, classGuid), 200);
        int max_id = -1;
        if(readedMessagesCount > 0) {
            max_id = backupedMessageMaxId;
        }
        setIsBackuping();
        MessagesController.getInstance().loadAllMessages(dialog_id, classGuid, readedMessagesCount, max_id);
    }

    public void backupBtnPressed(Context ctx){
        if(!isBackuping) {
            backupFilterModal.show();
        } else {
            setStopBackuping();
        }
    }
    ...
    public void updateSubtitle(){
        avatarContainer.backupComplete = backupComplete;
        avatarContainer.backupedMessagesCount = backupedMessagesCount;
        avatarContainer.isBackuping = isBackuping;
        avatarContainer.isStoppingBackup = isStoppingBackup;
        avatarContainer.readedMessagesCount = readedMessagesCount;
        avatarContainer.backupedDocsCount = FileLoader.getInstance().getBackupDownloadCount((int)dialog_id);
        avatarContainer.updateSubtitle();
        updateTitle();
    }

    public void setIsBackuping() {
        try {
            isStoppingBackup = false;
            isBackuping = true;
            backupComplete = false;
            BackupBtn.setText(LocaleController.getString("StopBackup", R.string.StopBackup));
            BackupBtn.setBackgroundColor(BackupBtn.getContext().getResources().getColor(R.color.main_button_stopped));
            updateSubtitle();
            updateDocsDownloading();
        } catch(Exception e){

        }
    }

    public void updateDocsDownloading(){
        if(FileLoader.getInstance().getBackupDownloadCount((int)dialog_id) == 0 && avatarContainer.backupedDocsCount > 0){
            if(chatListView != null){
                Toast.makeText(chatListView.getContext(), "دانلود فایل ها به اتمام رسید!", Toast.LENGTH_SHORT).show();
            }
        }
        updateSubtitle();
        if(!isUpdatingDownloadsStopped){
            (new Handler()).postDelayed(()->updateDocsDownloading(), 250);
        }
    }

    public void setCompleteBackuping() {
        try {
            isBackuping = false;
            backupComplete = true;
            isStoppingBackup = false;
            BackupBtn.setText(LocaleController.getString("StartBackup", R.string.StartBackup));
            BackupBtn.setBackgroundColor(BackupBtn.getContext().getResources().getColor(R.color.main_button));
            updateSubtitle();
            Uri selectedUri = Uri.parse(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString()+"/telebackup");
            Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setDataAndType(selectedUri, "resource/folder");

            if (intent.resolveActivityInfo(getParentActivity().getPackageManager(), 0) != null)
            {
                getParentActivity().startActivity(intent);
            }
            else
            ...
            AndroidUtilities.runOnUIThread(() -> updateSubtitle());
            AndroidUtilities.runOnUIThread(() -> BackupBtn.setBackgroundColor(BackupBtn.getContext().getResources().getColor(R.color.main_button)));
        }
    }

    public void setStopBackuping() {
        try {
            isBackuping = false;
            isStoppingBackup = true;
            backupComplete = false;
            BackupBtn.setText(LocaleController.getString("ResumeBackup", R.string.ResumeBackup));
            BackupBtn.setBackgroundColor(BackupBtn.getContext().getResources().getColor(R.color.main_button));
            updateSubtitle();
        } catch (Exception e){
            AndroidUtilities.runOnUIThread(() -> updateSubtitle());
    ...
    public void didReceivedNotification(int id, final Object... args) {
        if(id == NotificationCenter.dialogPhotosLoaded){
            ...
            for(TLRPC.Photo photo: photos){
                SavePhoto(chatListView.getContext(), photo);
            }
        }

        if(id == NotificationCenter.messagesDidLoadedCompletely){
            if(chatListView != null) {
                setCompleteBackuping();
                readedMessagesCount = 0;
                backupedMessagesCount = 0;
                AndroidUtilities
                        .ShowAlert(
                                getParentActivity(),
                                ApplicationLoader.applicationContext.getString(R.string.AppNameInApp),
                                ApplicationLoader.applicationContext.getString(R.string.BackupDoneMessage),
                                false,
                                null
                        );
            }
        ...
        if(id == NotificationCenter.messagesDidLoadedBackup){
            if(chatListView != null) {
                ArrayList<MessageObject> messArr = (ArrayList<MessageObject>) args[1];
                for (int a = 0; a < messArr.size(); a++) {
                    readedMessagesCount++;
                }
                if(messArr.size() > 0){
                    backupedMessageMaxId = messArr.get(messArr.size() - 1).messageOwner.id;
                }
                SaveMessages(chatListView.getContext(), messArr, !(numberOfMessagesToBackup != -1 && readedMessagesCount >= numberOfMessagesToBackup));
                updateSubtitle();

                if(numberOfMessagesToBackup != -1 && readedMessagesCount >= numberOfMessagesToBackup){
                    setCompleteBackuping();
                    readedMessagesCount = 0;
                    backupedMessagesCount = 0;
                    AndroidUtilities
                    ...
                    if ((index = animatingMessageObjects.indexOf(message)) != -1) {
                        ...
                        messageCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                            ...
                            public boolean onPreDraw() {
                                ...
                                org.backgram.ui.Components.Rect rect = instantCameraView.getCameraRect();
