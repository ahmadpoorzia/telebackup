...
import org.backgram.messenger.DispatchQueue;
import org.backgram.messenger.FileLog;
import org.backgram.messenger.Intro;
...
//        });
        ...
        startMessagingButton.setText(ApplicationLoader.applicationContext.getString(R.string.StartMessaging));
        startMessagingButton.setGravity(Gravity.CENTER);
        startMessagingButton.setTextColor(0xffffffff);
        startMessagingButton.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile.ttf"));
        ...
        frameLayout.addView(img, LayoutHelper.createFrame(100, 100, Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, 100, 0, 0));

        TextView titleTextView = new TextView(this);
        titleTextView.setText(ApplicationLoader.applicationContext.getString(R.string.AppNameInApp));
        titleTextView.setGravity(Gravity.CENTER);
        titleTextView.setTypeface(AndroidUtilities.getIranSansBoldTypeface());
        titleTextView.setTextSize(18);
        titleTextView.setTextColor(this.getResources().getColor(R.color.common_google_signin_btn_text_light_default));
        frameLayout.addView(titleTextView, LayoutHelper.createFrame(120, 60, Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, 220, 0, 0));

        TextView subtitleTextView = new TextView(this);
        subtitleTextView.setText(ApplicationLoader.applicationContext.getString(R.string.Slogan));
        subtitleTextView.setLineSpacing((float) 1, (float) 1.5);
        subtitleTextView.setGravity(Gravity.CENTER);
        subtitleTextView.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile.ttf"));
        subtitleTextView.setTextSize(16);
        frameLayout.addView(subtitleTextView, LayoutHelper.createFrame(180, 60, Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, 220 + 65, 0, 0));
...
//                viewPager.setCurrentItem(0);
    ...
    public class EGLThread extends DispatchQueue {
        ...
        private boolean initGL() {
            ...
            Intro.setBackgramTextures(textures[22], textures[21]);
