...
import org.backgram.tgnet.SerializedData;
...
import org.backgram.ui.Cells.TextInfoCell;
import org.backgram.ui.Cells.EmptyCell;
import org.backgram.ui.Cells.HeaderCell;
import org.backgram.ui.Cells.ShadowSectionCell;
import org.backgram.ui.Cells.TextCheckCell;
import org.backgram.ui.Cells.TextDetailSettingsCell;
import org.backgram.ui.Cells.TextSettingsCell;
...
import org.backgram.ui.Components.AvatarUpdater;
...
import org.backgram.ui.Components.NumberPicker;
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                if (position == textSizeRow) {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                    showDialog(builder.create());
                } else if (position == backgramFaqRow) {
                    Browser.openUrl(getParentActivity(), LocaleController.getString("BackgramFaqUrl", R.string.BackgramFaqUrl));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == textSizeRow) {
                        ...
                        textCell.setText(LocaleController.getString("BackgramFAQ", R.string.BackgramFAQ), true);
                    } else if (position == contactsReimportRow) {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == textSizeRow || position == enableAnimationsRow || position == notificationRow || position == backgroundRow || position == numberRow ||
                    ...
                    position == switchBackendButtonRow || position == backgramFaqRow || position == contactsSortRow || position == contactsReimportRow || position == saveToGalleryRow ||
            ...
            switch (viewType) {
                ...
                case 5:
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(LocaleController.formatString("BackgramVersion", R.string.BackgramVersion, String.format(Locale.US, "v%s (%d) %s", pInfo.versionName, code, abi)));
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                    break;
