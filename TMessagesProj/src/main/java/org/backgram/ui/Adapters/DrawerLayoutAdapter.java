...
//        items.add(new Item(6, LocaleController.getString("Contacts", R.string.Contacts), R.drawable.menu_contacts));
        ...
        items.add(new Item(13, LocaleController.getString("Help", R.string.Help), R.drawable.menu_saved));
...
//        items.add(new Item(8, LocaleController.getString("Settings", R.string.Settings), R.drawable.menu_settings));
        items.add(new Item(9, LocaleController.getString("Log Out", R.string.LogOut), R.drawable.menu_settings));
//        items.add(new Item(9, LocaleController.getString("BackgramFAQ", R.string.BackgramFAQ), R.drawable.menu_help));
    }
