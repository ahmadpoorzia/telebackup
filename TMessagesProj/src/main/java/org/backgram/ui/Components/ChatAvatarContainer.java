...
import org.backgram.ui.MediaActivity;
...
public class ChatAvatarContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean backupComplete = false;
    public boolean isStoppingBackup = false;
    public int readedMessagesCount = 0;
    public int backupedMessagesCount = 0;
    public int backupedDocsCount = 0;
    public int backupedMessageMaxId = 0;
    ...
    public ChatAvatarContainer(Context context, ChatActivity chatActivity, boolean needTime) {
        ...
        titleTextView.setTypeface(AndroidUtilities.getTypeface("fonts/IRANSansMobile.ttf"));
...
//        subtitleTextView.setTextSize(10);
    ...
    public void updateSubtitle() {
        if(backupComplete){
            if(backupedDocsCount > 0) {
                subtitleTextView.setText("فایل‌های در حال دانلود: "+ backupedDocsCount);
                return;
            }
            subtitleTextView.setText("ذخیره سازی تمام شد!");
            return;
        }
        if(isBackuping || backupedDocsCount > 0){
            if(backupedMessagesCount == 0){
                subtitleTextView.setText("شروع به ذخیره سازی...");
            } else {
                setSubtitleTextSize(12);
                subtitleTextView.setText("فایل‌های در حال دانلود: "+ backupedDocsCount);
            }
