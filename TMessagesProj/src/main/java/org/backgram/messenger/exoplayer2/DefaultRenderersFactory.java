 ...
 */
package org.backgram.messenger.exoplayer2;
...
import org.backgram.messenger.exoplayer2.audio.AudioCapabilities;
import org.backgram.messenger.exoplayer2.audio.AudioProcessor;
import org.backgram.messenger.exoplayer2.audio.AudioRendererEventListener;
import org.backgram.messenger.exoplayer2.audio.MediaCodecAudioRenderer;
import org.backgram.messenger.exoplayer2.drm.DrmSessionManager;
import org.backgram.messenger.exoplayer2.drm.FrameworkMediaCrypto;
import org.backgram.messenger.exoplayer2.mediacodec.MediaCodecSelector;
import org.backgram.messenger.exoplayer2.metadata.MetadataRenderer;
import org.backgram.messenger.exoplayer2.text.TextRenderer;
import org.backgram.messenger.exoplayer2.trackselection.TrackSelector;
import org.backgram.messenger.exoplayer2.video.MediaCodecVideoRenderer;
import org.backgram.messenger.exoplayer2.video.VideoRendererEventListener;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("org.backgram.messenger.exoplayer2.ext.vp9.LibvpxVideoRenderer");
  ...
  protected void buildAudioRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("org.backgram.messenger.exoplayer2.ext.opus.LibopusAudioRenderer");
    ...
    try {
      Class<?> clazz =
          Class.forName("org.backgram.messenger.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
    ...
    try {
      Class<?> clazz =
          Class.forName("org.backgram.messenger.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
