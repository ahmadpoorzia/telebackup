...
public final class ExoPlayerLibraryInfo {
  ...
  /**
   * Whether the library was compiled with {@link org.backgram.messenger.exoplayer2.util.Assertions}
   * checks enabled.
   */
  public static final boolean ASSERTIONS_ENABLED = true;

  /**
   * Whether the library was compiled with {@link org.backgram.messenger.exoplayer2.util.TraceUtil}
   * trace enabled.
   */
