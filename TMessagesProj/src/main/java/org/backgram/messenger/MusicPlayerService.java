...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "org.backgram.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "org.backgram.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "org.backgram.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "org.backgram.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "org.backgram.android.musicplayer.next";
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mediaSession = new MediaSession(this, "backgramAudioPlayer");
