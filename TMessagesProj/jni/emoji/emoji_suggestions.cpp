...
jobjectArray
Java_org_backgram_messenger_Emoji_getSuggestion(JNIEnv *env, jobject object, jstring query) {
    ...
    if (jclass_Suggestion == nullptr) {
        jclass_Suggestion = (jclass) env->NewGlobalRef(env->FindClass("org/backgram/messenger/EmojiSuggestion"));
